...
namespace StereoVision
{
	...
	private:
	 ...
	 MySV::MySV(Mat a, Mat b)
	{
		 Left_Corner_srcImage = a;
		 Right_Corner_srcImage = b;
	}
	 MySV::~MySV()
	 {
	 ...
	 //		描述：特征提取的回调函数
	 //-----------------------------------------------------------------------------------------------
	 void StereoVision::MySV::on_FeatureDetector(int, void*)
	 {
	 ...
	 //-----------------------------------------------------------------------------------------------
	 void StereoVision::MySV::Resize_Input_Img(Mat& Img, int length)
	 {
	 ...
	 //          描述：输出一些帮助信息
	 //----------------------------------------------------------------------------------------------
	 void StereoVision::MySV::ShowHelpText()
	 {
		 //输出欢迎信息和OpenCV版本
